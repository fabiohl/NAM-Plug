...
|:------------------------------------------------------- |:----------------------- |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Bitwig Studio** (Linux)                               | ✅ Full Support         | Floating GUI window (X11/Wayland), sample-accurate automation, state save/restore, and offline bounce.                                                                                                                                                                          |
| **REAPER** (Native Linux)                               | ✅ Full Support         | Floating GUI window (X11/Wayland), parameter automation, and ultra-low latency playback.                                                                                                                                                                                       |
| **PreSonus Studio One** / **Fender Studio Pro** (Linux) | ⚠️ Known GUI Limitation | **Known issue:** the host cannot initialize a natively embedded X11 GUI surface. NAM-Plug serves X11 floating-only (`CLAP_WINDOW_API_X11` with `is_floating = true`) and Wayland floating (`CLAP_WINDOW_API_WAYLAND`), opening its own top-level window with bounded teardown joins. |
